...
from networksecurity.entity.artifact_entity import DataTransformationArifact, DataValidationArtifact
...
class DataTransformation:
    ...
    def get_data_transformer_object(cls) -> Pipeline:
        ...
        logging.info(f"Entered get_data_transformer_object method")
        try:
