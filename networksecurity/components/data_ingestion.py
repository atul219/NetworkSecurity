...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self):
        try:
            logging.info(f"Exporting data from MongoDB as Dataframe")
    ...
    def export_data_into_feature_store(self, dataframe: pd.DataFrame):
        try:
            logging.info(f"Exporting dataframe in feature store")
    ...
    def split_data_as_train_test(self, dataframe: pd.DataFrame):
        try:
            logging.info(f"Splitting data as train and test csv")
